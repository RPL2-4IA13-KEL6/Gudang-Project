...
// jika user sudah login, maka jalankan perintah untuk export
  ...
  // mendefinisikan nama file hasil ekspor "Data-vendor.xls"
  ...
  <table border="1">
    <thead>
      <tr style="background-color:#6861ce;color:#fff">
        ...
        <th height="30" align="center" vertical="center">Vendor</th>
      </tr>
    </thead>
    <tbody>
      <?php
      ...
      $query = mysqli_query($mysqli, "SELECT * FROM tbl_vendor ORDER BY nama_vendor ASC")
      ...
      while ($data = mysqli_fetch_assoc($query)) { ?>
        ...
        <tr>
          ...
          <td width="500"><?php echo $data['nama_vendor']; ?></td>
        </tr>
      <?php } ?>
    </tbody>
  </table>
