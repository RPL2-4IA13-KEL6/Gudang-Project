...
// jika user sudah login, maka jalankan perintah untuk export
  ...
  // mendefinisikan nama file hasil ekspor "Laporan Data Barang Rusak.xls"
  header("Content-Disposition: attachment; filename=Laporan Data Barang Rusak.xls");
?>
  <!-- halaman HTML yang akan diexport ke excel -->
  <!-- judul tabel -->
  <center>
    <h4>
      LAPORAN DATA BARANG RUSAK<br>
  ...
  <table border="1">
    <thead>
      <tr style="background-color:#6861ce;color:#fff">
        ...
        <th height="30" align="center" vertical="center">Jumlah Rusak</th>
