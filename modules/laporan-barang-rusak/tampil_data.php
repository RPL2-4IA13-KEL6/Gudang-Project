  ...
  <div class="panel-header bg-secondary-gradient">
    <div class="page-inner py-4">
      <div class="page-header text-white">
        <!-- judul halaman -->
        <h4 class="page-title text-white"><i class="fas fa-file-export mr-2"></i> Laporan Barang Rusak</h4>
        <!-- breadcrumbs -->
        <ul class="breadcrumbs">
          ...
          <li class="separator"><i class="flaticon-right-arrow"></i></li>
          <li class="nav-item"><a>Barang Rusak</a></li>
        </ul>
      </div>
    </div>
  </div>
    ...
    <div class="page-inner mt--5">
      <div class="card">
        <div class="card-header">
          <!-- judul form -->
          <div class="card-title">Filter Data Barang Rusak</div>
        </div>
        <!-- form filter data -->
        <div class="card-body">
          <form action="?module=laporan_barang_rusak" method="post" class="needs-validation" novalidate>
            <div class="row">
              <div class="col-lg-3">
            ...
            <div class="row">
              ...
              <div class="col-lg-2 pr-0">
                <div class="form-group pt-3">
                  ...
                  <a href="modules/laporan-barang-rusak/cetak.php?tanggal_awal=<?php echo $tanggal_awal; ?>&tanggal_akhir=<?php echo $tanggal_akhir; ?>" target="_blank" class="btn btn-warning btn-round btn-block mt-4">
              ...
              <div class="col-lg-2 pl-0">
                <div class="form-group pt-3">
                  ...
                  <a href="modules/laporan-barang-rusak/export.php?tanggal_awal=<?php echo $tanggal_awal; ?>&tanggal_akhir=<?php echo $tanggal_akhir; ?>" target="_blank" class="btn btn-success btn-round btn-block mt-4">
      ...
      <div class="card">
        <div class="card-header">
          ...
          <div class="card-title">
            <i class="fas fa-file-alt mr-2"></i> Laporan Data Barang Rusak Tanggal <strong><?php echo $tanggal_awal; ?></strong> s.d. <strong><?php echo $tanggal_akhir; ?></strong>
          </div>
        </div>
        <div class="card-body">
          <div class="table-responsive">
            ...
            <table id="basic-datatables" class="display table table-bordered table-striped table-hover">
              ...
              <tbody>
                ...
                $query = mysqli_query($mysqli, "SELECT a.id_transaksi, a.tanggal, j.nama_jenis, a.barang, a.jumlah, b.nama_barang, c.nama_satuan, b.id_vendor, b.id_lokasi, d.nama_vendor, e.nama_lokasi
                ...
                while ($data = mysqli_fetch_assoc($query)) { ?>
                  ...
                  <tr>
                    ...
                    <td width="120"><?php echo $data['nama_jenis']; ?></td>
                    <td width="100" class="text-right"><?php echo number_format($data['jumlah'], 0, '', '.'); ?></td>
                    <td width="60"><?php echo $data['nama_satuan']; ?></td>
                    <td width="120"><?php echo $data['nama_vendor']; ?></td>
                    <td width="120"><?php echo $data['nama_lokasi']; ?></td>
                  </tr>
                <?php } ?>
              </tbody>
            </table>
