            ...
            <table id="basic-datatables" class="display table table-bordered table-striped table-hover">
              <thead>
                <tr>
                  ...
                  <th class="text-center">Barang</th> <!-- Posisikan sebelum kolom Jenis Barang -->
                  <th class="text-center">Jenis Barang</th> <!-- Posisikan setelah kolom Barang -->
              ...
              <tbody>
                ...
                while ($data = mysqli_fetch_assoc($query)) { ?>
                  ...
                  <tr>
                    ...
                    <td width="120"><?php echo $data['nama_jenis']; ?></td> <!-- Posisikan setelah kolom Barang -->
                    <td width="100" class="text-right"><?php echo number_format($data['jumlah'], 0, '', '.'); ?></td>
                    <td width="60"><?php echo $data['nama_satuan']; ?></td>
                    <td width="120"><?php echo $data['nama_vendor']; ?></td> <!-- Kolom Vendor -->
                    <td width="120"><?php echo $data['nama_lokasi']; ?></td> <!-- Kolom Lokasi -->
                  </tr>
                <?php } ?>
              </tbody>
            </table>
