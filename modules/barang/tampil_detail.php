...
// jika file di include oleh file lain, tampilkan isi file
  ...
  if (isset($_GET['id'])) {
    ...
    $query = mysqli_query($mysqli, "SELECT a.id_barang, a.nama_barang, a.jenis, a.stok_minimum, a.stok, a.satuan, a.foto, b.nama_jenis, c.nama_satuan, d.nama_vendor, e.nama_lokasi
                                    FROM tbl_barang as a 
                                    INNER JOIN tbl_jenis as b ON a.jenis = b.id_jenis 
                                    INNER JOIN tbl_satuan as c ON a.satuan = c.id_satuan 
                                    INNER JOIN tbl_vendor as d ON a.id_vendor = d.id_vendor 
                                    INNER JOIN tbl_lokasi as e ON a.id_lokasi = e.id_lokasi
