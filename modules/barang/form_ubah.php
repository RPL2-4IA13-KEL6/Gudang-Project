...
// jika file di include oleh file lain, tampilkan isi file
  ...
  if (isset($_GET['id'])) {
    ...
    $query = mysqli_query($mysqli, "SELECT a.id_barang, l.id_lokasi, v.id_vendor, l.nama_lokasi, v.nama_vendor, a.nama_barang, a.jenis, a.stok_minimum, a.stok, a.satuan, a.foto, 
                                ...
                                INNER JOIN tbl_lokasi AS l ON a.id_lokasi = l.id_lokasi 
                                INNER JOIN tbl_vendor AS v ON a.id_vendor = v.id_vendor 
          ...
          <div class="row">
            <div class="col-md-7">
              ...
              <div class="form-group">
                ...
                <select name="vendor" class="form-control chosen-select" autocomplete="off" required>
                  ...
                  $query_vendor = mysqli_query($mysqli, "SELECT * FROM tbl_vendor ORDER BY nama_vendor ASC")
                    or die('Ada kesalahan pada query tampil data : ' . mysqli_error($mysqli));
                  // ambil data hasil query
                  while ($data_vendor = mysqli_fetch_assoc($query_vendor)) {
                    // tampilkan data
              ...
              <div class="form-group">
                ...
                <select name="lokasi" class="form-control chosen-select" autocomplete="off" required>
                  ...
                  $query_lokasi = mysqli_query($mysqli, "SELECT * FROM tbl_lokasi ORDER BY nama_lokasi ASC")
                    or die('Ada kesalahan pada query tampil data : ' . mysqli_error($mysqli));
                  // ambil data hasil query
