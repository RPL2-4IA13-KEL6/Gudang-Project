        ...
        <div class="table-responsive">
          ...
          <table id="basic-datatables" class="display table table-bordered table-striped table-hover">
            ...
            <tbody>
              ...
              $no = 1;
              // sql statement untuk menampilkan data dari tabel "tbl_barang", tabel "tbl_satuan", dan tabel "tbl_jenis"
              $query = mysqli_query($mysqli, "SELECT a.id_barang, a.nama_barang, a.stok, a.satuan, 
                    b.nama_satuan, v.nama_vendor, l.nama_lokasi, j.nama_jenis
              ...
              while ($data = mysqli_fetch_assoc($query)) { ?>
                ...
                <tr>
                  ...
                  <td width="100"><?php echo $data['nama_vendor']; ?></td>
                  <td width="100"><?php echo $data['nama_lokasi']; ?></td>
