...
// jika user sudah login, maka jalankan perintah untuk insert
  ...
  if (isset($_POST['simpan'])) {
    ...
    if (empty($nama_file)) {
      ...
      $insert = mysqli_query($mysqli, "INSERT INTO tbl_barang(id_barang, nama_barang, jenis, stok_minimum, satuan, id_vendor, id_lokasi) 
                                       VALUES('$id_barang', '$nama_barang', '$jenis', '$stok_minimum', '$satuan', '$vendor', '$lokasi')")
    ...
    // jika data foto ada
      ...
      if (move_uploaded_file($tmp_file, $path)) {
        // sql statement untuk insert data ke tabel "tbl_barang"
        $insert = mysqli_query($mysqli, "INSERT INTO tbl_barang(id_barang, nama_barang, jenis, stok_minimum, satuan, foto, id_vendor, id_lokasi) 
                                         VALUES('$id_barang', '$nama_barang', '$jenis', '$stok_minimum', '$satuan', '$nama_file_enkripsi', '$vendor', '$lokasi')")
          or die('Ada kesalahan pada query insert : ' . mysqli_error($mysqli));
        // cek query
        // jika proses insert berhasil
        if ($insert) {
