...
// jika user sudah login, maka jalankan perintah untuk cetak
              ...
              <table class="table" width="100%" cellspacing="0">
                <thead>
                  <tr>
                    ...
                    <th>Tanggal</th>
                    <th>Barang</th>
                    <th>Jenis Barang</th> <!-- Kolom Jenis Barang -->
                    <th>Jumlah Masuk</th>
                    <th>Satuan</th>
  ...
  $query = mysqli_query($mysqli, "SELECT a.id_transaksi, a.tanggal, a.barang, a.jumlah, b.nama_barang, c.nama_satuan, b.id_vendor, b.id_lokasi, d.nama_vendor, e.nama_lokasi, f.nama_jenis
                                  FROM tbl_barang_masuk as a INNER JOIN tbl_barang as b INNER JOIN tbl_satuan as c INNER JOIN tbl_vendor as d INNER JOIN tbl_lokasi as e INNER JOIN tbl_jenis as f
                                  ON a.barang=b.id_barang AND b.satuan=c.id_satuan AND b.id_vendor=d.id_vendor AND b.id_lokasi=e.id_lokasi AND b.jenis=f.id_jenis
  ...
  while ($data = mysqli_fetch_assoc($query)) {
    ...
    $html .= '    <tr>
                    ...
                    <td>' . $data['nama_jenis'] . '</td> <!-- Kolom Jenis Barang -->
