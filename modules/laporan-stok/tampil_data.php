            ...
            <div class="table-responsive">
              ...
              <table id="basic-datatables" class="display table table-bordered table-striped table-hover">
                ...
                <tbody>
                  ...
                  $query = mysqli_query($mysqli, "SELECT a.id_barang, a.nama_barang, a.jenis, a.stok_minimum, a.stok, a.satuan, b.nama_jenis, c.nama_satuan, d.nama_vendor, e.nama_lokasi
                  ...
                  while ($data = mysqli_fetch_assoc($query)) { ?>
                    ...
                    <tr>
                      ...
                      <td width="150"><?php echo $data['nama_vendor']; ?></td>
                      <td width="150"><?php echo $data['nama_lokasi']; ?></td>
                    </tr>
                  <?php } ?>
                </tbody>
              </table>
