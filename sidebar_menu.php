  ...
  if ($_SESSION['hak_akses'] == 'Administrator') {
    ...
    if ($_GET['module'] == 'barang' || $_GET['module'] == 'tampil_detail_barang' || $_GET['module'] == 'form_entri_barang' || $_GET['module'] == 'form_ubah_barang') { ?>
      <li class="nav-section">
        ...
        <h4 class="text-section">Master Barang</h4>
      </li>
    ...
    // jika menu vendor (tampil data / form entri) dipilih, menu vendor aktif
if ($_GET['module'] == 'vendor' || $_GET['module'] == 'form_entri_vendor') { ?>
  <li class="nav-section">
    <span class="sidebar-mini-icon">
      <i class="fa fa-ellipsis-h"></i>
    </span>
    <h4 class="text-section">Master Vendor</h4>
  </li>
...
// jika tidak dipilih, menu vendor tidak aktif
else { ?>
  <li class="nav-section">
    <span class="sidebar-mini-icon">
      <i class="fa fa-ellipsis-h"></i>
...
<?php
    ...
    // jika menu barang rusak (tampil data / form entri) dipilih, menu barang rusak aktif
if ($_GET['module'] == 'barang_rusak' || $_GET['module'] == 'form_entri_barang_rusak') { ?>
  <li class="nav-item active">
...
// jika tidak dipilih, menu barang rusak tidak aktif
else { ?>
  <li class="nav-item">
    <a href="?module=barang_rusak">
      <i class="fas fa-exclamation-triangle"></i>
...
<?php
    ...
    // jika menu laporan barang rusak dipilih, menu laporan barang rusak aktif
if ($_GET['module'] == 'laporan_barang_rusak') { ?>
  <li class="nav-item active">
    <a href="?module=laporan_barang_rusak">
...
// jika tidak dipilih, menu laporan barang rusak tidak aktif
else { ?>
  <li class="nav-item">
    <a href="?module=laporan_barang_rusak">
      <i class="fas fa-file-excel"></i>
