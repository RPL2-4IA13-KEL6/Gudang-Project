...
// jika file di include oleh file lain, tampilkan isi file
  ...
  if ($_GET['module'] == 'dashboard') {
    ...
    include "modules/lokasi/tampil_data.php";
  } elseif ($_GET['module'] == 'form_entri_lokasi') {
    include "modules/lokasi/form_entri.php";
  } elseif ($_GET['module'] == 'form_ubah_lokasi') {
    include "modules/lokasi/form_ubah.php";
  } elseif ($_GET['module'] == 'vendor') {
    include "modules/vendor/tampil_data.php";
  } elseif ($_GET['module'] == 'form_entri_vendor') {
    include "modules/vendor/form_entri.php";
  } elseif ($_GET['module'] == 'form_ubah_vendor') {
    include "modules/vendor/form_ubah.php";
  }

  // Module untuk Barang Rusak
  if ($_GET['module'] == 'barang_rusak') {
    // Hanya Administrator dan Admin Gudang yang dapat mengakses
    if ($_SESSION['hak_akses'] == 'Administrator' || $_SESSION['hak_akses'] == 'Admin Gudang') {
        include "modules/barang-rusak/tampil_data.php";
    } else {
        echo "<p>Akses ditolak. Anda tidak memiliki hak untuk mengakses modul ini.</p>";
    }
  } elseif ($_GET['module'] == 'form_entri_barang_rusak') {
    // Hanya Administrator dan Admin Gudang yang dapat mengakses
    if ($_SESSION['hak_akses'] == 'Administrator' || $_SESSION['hak_akses'] == 'Admin Gudang') {
        include "modules/barang-rusak/form_entri.php";
    } else {
        echo "<p>Akses ditolak. Anda tidak memiliki hak untuk mengakses modul ini.</p>";
    }
  } elseif ($_GET['module'] == 'form_ubah_barang_rusak') {
    // Hanya Administrator dan Admin Gudang yang dapat mengakses
    if ($_SESSION['hak_akses'] == 'Administrator' || $_SESSION['hak_akses'] == 'Admin Gudang') {
        include "modules/barang-rusak/form_ubah.php";
    } else {
        echo "<p>Akses ditolak. Anda tidak memiliki hak untuk mengakses modul ini.</p>";
    }
  }

  // Tambahkan module untuk laporan barang rusak
  if ($_GET['module'] == 'laporan_barang_rusak') {
    // panggil file tampil data laporan barang rusak
    include "modules/laporan-barang-rusak/tampil_data.php";
  }
  ...
  // jika module yang dipilih "laporan_barang_rusak"
  elseif ($_GET['module'] == 'laporan_barang_rusak') {
    // panggil file tampil data laporan barang rusak
    include "modules/laporan-barang-rusak/tampil_data.php";
  }
