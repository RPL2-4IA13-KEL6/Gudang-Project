...
// jika user sudah login, tampilkan halaman konten
  ...
  <head>
    ...
    <meta name="description" content="Manajemen Inventory" />
        ...
        <div class="logo-header" data-background-color="purple">
          ...
          <a href="?module=dashboard" class="logo">
            <div class="navbar-brand">
              <span><img src="assets/img/logo.png" alt="Logo" width="40px"></span>
        ...
        <footer class="footer">
          <div class="container-fluid">
            <div class="copyright ml-auto">
              <!-- Copyright &copy; 2023 -  -->
              <a href="https://drive.google.com/file/d/1K1OLQAswaL-vAsPrIMtCZ-FUE1hCkiBo/view?usp=sharing" class="text-secondary" target="_blank">Panduan Aplikasi</a>
            </div>
          </div>
        </footer>
        <!-- End Footer -->
